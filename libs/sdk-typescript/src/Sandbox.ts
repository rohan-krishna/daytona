...
import {
  ...
  ListSandboxesResponse as ListSandboxesResponseDto,
  PortPreviewUrl,
  SandboxVolume,
  BuildInfo,
...
export interface ListSandboxesResponse extends Omit<ListSandboxesResponseDto, 'items'> {
  /**
   * List of Sandboxes in the current page
   * */
  items: Sandbox[]
}

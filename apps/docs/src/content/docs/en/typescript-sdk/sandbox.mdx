...
- `items` _Sandbox\[\]_
- `page` _number_
    - _Inherited from_: `PaginatedSandboxesDeprecated.page`
- `total` _number_
    - _Inherited from_: `PaginatedSandboxesDeprecated.total`
- `totalPages` _number_ - PaginatedSandboxesDeprecated
    - _Inherited from_: `PaginatedSandboxesDeprecated.totalPages`
